...
from data_utils import FashionIQDataset, ShoesDataset, Fashion200kDataset
...
def extract_index_features(dataset: Union[FashionIQDataset, ShoesDataset, Fashion200kDataset], clip_model: nn.Module) -> \
    ...
    elif isinstance(dataset, ShoesDataset):
        print(f"extracting Shoes  - {dataset.split} index features")
    elif isinstance(dataset, Fashion200kDataset):
        pin_memory = False
